...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-4WJGiwd8.mjs");
...
var manifest = {
	"d4a5fb700a0f60b7f2e8d605315bcd4ad71b62e59ffebad3024f6932cade8445": {
		functionName: "completeOnce_createServerFn_handler",
		importer: () => import("./client-5soDfSX2.mjs")
	},
	"e7fd996a546c9dfe2eaf8857329251ff910df226ca7663e7652f24a0baf69443": {
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-CZN6zBQO.mjs").then((n) => n.t),
